...
#define path1 "clockdesktop.jpg"
#define path2 "beeper_desktop.jpg"
#define path3 "explain_desktop.jpg"
#define path4 "recorderdesktop.jpg"
#define path5 "gyro_desktop.jpg"
...
extern void DMA2D_CopyBuffer(uint32_t *pSrc, uint32_t *pDst, uint16_t x, uint16_t y, uint16_t xsize, uint16_t ysize, uint32_t ChromaSampling);
